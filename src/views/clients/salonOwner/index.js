                  ...
                  <CCol sm="6">
                    <CFormGroup>
                      ...
                      <CInput
                        ...
                        id="name"
                        name="name"
                        placeholder="Enter Salon Owner's Name..."
                      />
                      <CFormText className="help-block">
                        Please enter Salon Owner's name
                      </CFormText>
                    </CFormGroup>
                  </CCol>
                  <CCol sm="6">
                    <CFormGroup>
                      ...
                      <CInput
                        ...
                        id="password"
                        name="password"
                        placeholder="Enter Salon Owner's Password..."
                      />
                      <CFormText className="help-block">
                        Please enter Salon Owner's password
                      </CFormText>
                    </CFormGroup>
                  </CCol>
                  <CCol sm="12">
                    <CFormGroup>
                      ...
                      <CInput
                        ...
                        id="user_name"
                        name="user_name"
                        placeholder="Enter Salon Owner's Username..."
                      />
                      <CFormText className="help-block">
                        Please choose Salon Owner's username
                      </CFormText>
                    </CFormGroup>
                  </CCol>
                </CRow>
